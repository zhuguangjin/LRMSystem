		...
		<tr>
			...
			<td valign="top" background="../Images//content_bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					<tr>
						<td height="31"><div class="title1">实验室设备列表</div></td>
					</tr>
				</table>
			</td>
						...
						<td colspan="4">
							<table>
								<tr>
									...
									<td valign="bottom"><h3 style="letter-spacing: 1px;">在这里，您可以查看实验室设备资源列表！</h3></td>
								</tr>
							</table>
						</td>
					</tr>
								...
								<tr>
									<td colspan="2">
										<table class="defaultlist">
											...
											<!-- 遍历开始 -->
											<s:iterator value="#session.labDeviceList" var="labDevice">
												<tr>
													<td><s:property value="#labDevice.labDeviceId" /></td>
													<td><s:property value="#labDevice.labDeviceNumber" /></td>
													<td><s:property value="#labDevice.labDeviceName" /></td>
													<td><s:property value="#labDevice.laboratory.labName" /></td>
													<td><a
														href="<%=path%>/admin/labDevice_labDeviceDelete.action?labDeviceId=<s:property value=" #labDevice.labDeviceId"/>"
										...
										<div id="TableTail">
											<div id="TableTail_inside">
												<input type="button"
													onclick="location.href='labdevice_add.jsp'" value="新建" />
											</div>
										</div>
									</td>
								</tr>
