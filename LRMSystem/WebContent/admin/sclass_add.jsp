		...
		<tr>
			...
			<td valign="top" background="../Images//content_bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					<tr>
						<td height="31"><div class="title1">班级添加</div></td>
					</tr>
				</table>
			</td>
						...
						<td colspan="4">
							<table>
								<tr>
									...
									<td valign="bottom"><h3 style="letter-spacing: 1px;">在这里，您可以添加班级！</h3></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr height="340" valign="top">
						...
						<td width="96%">
							<table width="100%">
								<tr>
									<td colspan="2">
										<form action="sclass_sclassAdd" method="post">
