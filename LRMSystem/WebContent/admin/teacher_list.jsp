		...
		<tr>
			...
			<td valign="top" background="../Images//content_bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					<tr>
						<td height="31"><div class="title1">老师列表</div></td>
					</tr>
				</table>
			</td>
						...
						<td colspan="4">
							<table>
								<tr>
									...
									<td valign="bottom"><h3 style="letter-spacing: 1px;">在这里，您可以查看老师列表！</h3></td>
								</tr>
							</table>
						</td>
					</tr>
								...
								<tr>
									<td colspan="2">
										<table class="defaultlist">
											...
											<!-- 遍历开始 -->
											<s:iterator value="#session.teacherList" var="teacher">
												<tr>
													<td><s:property value="#teacher.teacherId" /></td>
													<td><s:property value="#teacher.teacherUsername" /></td>
													<td><s:property value="#teacher.teacherPassword" /></td>
													<td><s:property value="#teacher.teacherNumber" /></td>
													<td><s:property value="#teacher.teacherPhoneNum" /></td>
													<td><s:property value="#teacher.teacherEmail" /></td>
													<td><a
														href="<%=path%>/admin/teacher_teacherDelete.action?teacherId=<s:property value=" #teacher.teacherId"/>"
										...
										<div id="TableTail">
											<div id="TableTail_inside">
												<input type="button" onclick="location.href='teacher_add.jsp'" value="新建"/>
											</div>
										</div>
									</td>
								</tr>
