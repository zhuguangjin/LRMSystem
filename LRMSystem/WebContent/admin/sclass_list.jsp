						...
						<td colspan="4">
							<table>
								<tr>
									...
									<td valign="bottom"><h3 style="letter-spacing: 1px;">在这里，您可以查看班级列表！</h3></td>
								</tr>
							</table>
						</td>
					</tr>
								...
								<tr>
									<td colspan="2">
										<table class="defaultlist">
											...
											<!-- 遍历开始 -->
											<s:iterator value="#session.sclassList" var="sclass">
												<tr>
													<td><s:property value="#sclass.soclassId" /></td>
													<td><s:property value="#sclass.soclassName" /></td>
													<td><s:property value="#sclass.soclassGrade" /></td>
													<td><s:property value="#sclass.soclassMajor" /></td>
													<td><s:property value="#sclass.academy" /></td>
													<td><a
														href="<%=path%>/admin/sclass_sclassDelete.action?soclassId=<s:property value=" #sclass.soclassId"/>"
										...
										<div id="TableTail">
											<div id="TableTail_inside">
												<input type="button" onclick="location.href='<%=path%>/admin/sclass_sclassAddUI.action'" value="新建"/>
											</div>
										</div>
									</td>
								</tr>
