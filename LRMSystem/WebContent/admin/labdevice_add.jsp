		...
		<tr>
			...
			<td valign="top" background="../Images//content_bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					<tr>
						<td height="31"><div class="title1">设备添加</div></td>
					</tr>
				</table>
			</td>
						...
						<td colspan="4">
							<table>
								<tr>
									...
									<td valign="bottom"><h3 style="letter-spacing: 1px;">在这里，您可以添加设备资源！</h3></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr height="340" valign="top">
						...
						<td width="96%">
							<table width="100%">
								<tr>
									<td colspan="2">
										<form action="labDevice_labDeviceAdd" method="post">
											<table width="100%" class="cont">
												<tr>
													<td width="2%">&nbsp;</td>
													<td width="15%">设备名称：</td>
													<td width="25%"><input class="text" type="text"
														name="labDeviceName"/></td>
													<td>设置设备的名称</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													...
													<td width="15%">设备编号：</td>
													<td width="25%"><input class="text" type="text"
														name="labDeviceNumber"  /></td>
													<td>设置设备资源的编号</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td width="2%">&nbsp;</td>
													<td width="15%">设备所属实验室ID：</td>
													<td width="25%"><input class="text" type="text"
														name="laboratory.labId" /></td>
													<td>设置所属实验室ID</td>
													<td width="2%">&nbsp;</td>
												</tr>									
												<tr>
