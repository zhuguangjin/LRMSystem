										...
										<table class="defaultlist">
											...
											<s:iterator value="#request.labtbList" var="labtb">
												<tr>
													...
													<td><a
														href="<%=path%>/admin/labttable_labFinishedDelete.action?labTimeTableId=<s:property value=" #labtb.labTimeTableId"/>"
														onclick="javascript: return confirm('需要删除已完成实验吗？');">删除</a></td>
												</tr>
											</s:iterator>
											<!-- 遍历结束 -->
										</table> <!-- 其他功能超链接 -->
