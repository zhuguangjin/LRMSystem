		...
		<tr>
			...
			<td valign="top" background="../Images//content_bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					<tr>
						<td height="31"><div class="title1">实验室列表</div></td>
					</tr>
				</table>
			</td>
						...
						<td colspan="4">
							<table>
								<tr>
									...
									<td valign="bottom"><h3 style="letter-spacing: 1px;">在这里，您可以查看实验室列表！</h3></td>
								</tr>
							</table>
						</td>
					</tr>
								...
								<tr>
									<td colspan="2">
										<table class="defaultlist">
											...
											<!-- 遍历开始 -->
											<s:iterator value="#session.laboratoryList" var="laboratory">
												<tr>
													<td><s:property value="#laboratory.labId" /></td>
													<td><s:property value="#laboratory.labName" /></td>
													<td><s:property value="#laboratory.labBrief" /></td>
													<td><s:property value="#laboratory.labLocation" /></td>
													<td><s:property value="#laboratory.teacher.teacherUsername" /></td>
												
													<td><a
														href="<%=path%>/admin/laboratory_laboratoryDelete.action?labId=<s:property value=" #laboratory.labId"/>"
										...
										<div id="TableTail">
											<div id="TableTail_inside">
												<input type="button" onclick="location.href='laboratory_add.jsp'" value="新建"/>
											</div>
										</div>
									</td>
								</tr>
