			...
			<td width="182" valign="top">
				<div id="container">
					...
					<div class="content">
						...
						<ul class="RM">
							<li><a href="./teacher_teacherInfoUI.action" target="main">个人信息</a></li>
							<li><a href="./teaTimeTable_showTeacherTimeTable.action" target="main">查看课表</a></li>							
						</ul>
					</div>
					<h1 class="type">
					...
					<div class="content">
						...
						<ul class="RM">
							<li><a href="./teaTimeTable_getClassListFromTable.action" target="main">班级列表</a></li>
						</ul>
					</div>
					<h1 class="type">
					...
					<div class="content">
						...
						<ul class="RM">
							<li><a href="./teacher_teacherReserveLabUI.action" target="main">预约实验室</a></li>
							<li><a href="./labttable_labHandleListUI.action" target="main">已完成预约</a></li>
