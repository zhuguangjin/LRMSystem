					...
					<tr height="340" valign="top">
						...
						<td width="96%">
							<table width="100%">
								<tr>
									<td colspan="2">
										<form action="teacher_teacherEdit" method="post">
										
											<table width="100%" class="cont">
											<s:iterator value="#session.tlogin">
												<tr>
													<td width="2%">&nbsp;</td>
													<td width="15%">用户ID：</td>
													<td width="25%"><input class="text" type="text"
														name="teacherId" value="${tlogin.teacherId}" readonly="readonly"/></td>
													<td>用户ID不能设置</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													...
													<td width="15%">用户名：</td>
													<td width="25%"><input class="text" type="text"
														name="teacherUsername" value="${tlogin.teacherUsername}"/></td>
													<td>设置用户名</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													...
													<td width="15%">密码：</td>
													<td width="25%"><input class="text" type="text"
														name="teacherPassword" value="${tlogin.teacherPassword}" /></td>
													<td>设置用户的登录密码</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													...
													<td width="15%">工号：</td>
													<td width="25%"><input class="text" type="text"
														name="teacherNumber" value="${tlogin.teacherNumber}"/></td>
													<td>设置用户工号</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													...
													<td width="15%">电话号码：</td>
													<td width="25%"><input class="text" type="text"
														name="teacherPhoneNum" value="${tlogin.teacherPhoneNum}" /></td>
													<td>设置用户电话号码</td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													...
													<td width="15%">用户邮箱：</td>
													<td width="25%"><input class="text" type="text"
														name="teacherEmail" value="${tlogin.teacherEmail}"/></td>
													<td>设置设置用户邮箱</td>
													<td width="2%">&nbsp;</td>
												</tr>
