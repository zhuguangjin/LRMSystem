		...
		<tr>
			...
			<td valign="top" background="../Images//content_bg.gif">
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					<tr>
						<td height="31"><div class="title1">老师信息</div></td>
					</tr>
				</table>
			</td>
										...
										<table width="100%" class="cont">
											<s:iterator value="#session.tlogin">
											    <tr>
													<td width="20%">&nbsp;</td>
													<td width="15%">用户ID：</td>
													<td width="25%">${tlogin.teacherId}</td>
                                                    <td></td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td width="20%">&nbsp;</td>
													<td width="15%">用户名：</td>
													<td width="25%">${tlogin.teacherUsername}</td>
                                                    <td></td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td width="20%">&nbsp;</td>
													<td width="15%">密码：</td>
													<td width="25%">${tlogin.teacherPassword}</td>
													<td></td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td width="20%">&nbsp;</td>
													<td width="15%">工号：</td>
													<td width="25%">${tlogin.teacherNumber}</td>
													<td></td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td width="20%">&nbsp;</td>
													<td width="15%">电话号码：</td>
													<td width="25%">${tlogin.teacherPhoneNum}</td>
													<td></td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td width="20%">&nbsp;</td>
													<td width="15%">用户邮箱：</td>
													<td width="25%">${tlogin.teacherEmail}</td>
													<td></td>
													<td width="2%">&nbsp;</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
													<td><a
														href="<%=path%>/teachers/teacher_teacherEditUI.action?teacherId=%{tlogin.teacherId}"
